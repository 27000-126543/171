    ...
    <div className="flex flex-col gap-5">
          ...
          <table className="w-full min-w-[900px] text-sm">
            <thead>
              <tr className="border-b border-white/8 text-left text-white/50">
                ...
                <th className="px-4 py-3 font-medium">租金单价(元/m²/月)</th>
      ...
      {billsModalOpen && billsShop && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-2xl animate-fade-in rounded-xl border border-white/8 bg-dark-800 p-6 shadow-2xl">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  {shopBills.length === 0 && (
                    <tr><td colSpan={5} className="px-3 py-8 text-center text-white/30">暂无账单</td></tr>
                  )}
                </tbody>
              </table>
            </div>
